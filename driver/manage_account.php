...
if($_settings->userdata('id') > 0 && $_settings->userdata('login_type') == 3){
    $qry = $conn->query("SELECT * FROM `electrician_user` where id = '{$_settings->userdata('id')}'");
    if($qry->num_rows >0){
        $res = $qry->fetch_array();
        foreach($res as $k => $v){
            if(!is_numeric($k)){
                    ...
                    <form id="register-frm" action="" method="post">
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                <input type="text" name="electrician_name" id="electrician_name" placeholder="Enter Fullname Name" autofocus class="form-control form-control-sm form-control-border" value="<?= isset($electrician_name) ? $electrician_name : "" ?>" required>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                <input type="text" name="electrician_contact" id="electrician_contact" placeholder="Enter Contact #" class="form-control form-control-sm form-control-border" required value="<?= isset($electrician_contact) ? $electrician_contact : "" ?>">
                        ...
                        <div class="row">
                            ...
                            <textarea name="electrician_address" id="electrician_address" rows="3" class="form-control form-control-sm rounded-0" placeholder="Block 6 Lot 23, Here Subd., There City, Anywhere, 2306"><?= isset($electrician_address) ? $electrician_address : "" ?></textarea>
                            </div>
                        </div>
                        <hr>
                        <div class="row">
