...
<?php $page = isset($_GET['page']) ? $_GET['page'] : 'home';  ?>
  ...
  <div class="card card-outline card-purple">
    <div class="card-header text-center">
      <a href="./" class="h4 text-decoration-none"><b>Electician Login Panel</b></a>
    </div>
    <div class="card-body">
      ...
      <form id="dlogin-frm" action="" method="post">
        ...
        <div class="input-group-append">
          ...
          <input type="text" class="form-control" name="electricianSer_ID" placeholder="Electrician Service ID">
