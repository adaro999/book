...
<div class="container-fluid">
    ...
    <div class="text-right">
        ...
        <button class="btn btn-warning btn-flat bg-gradient-warning" type="button" id="pickup_booking">In Progress</button>
...
<script>
    $(function(){
        ...
        $('#pickup_booking').click(function(){
            _conf("Mark [Ref. Code: <b><?= isset($ref_code) ? $ref_code : "" ?></b>] booking as In Progress?", "update_booking_status",["<?= isset($id) ? $id : "" ?>",2])
        }) 
