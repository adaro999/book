...
--
-- Table structure for table `electrician_user`
--

CREATE TABLE `electrician_user` (
  `id` int(30) NOT NULL,
  `electricianSer_ID` varchar(100) NOT NULL,
  ...
  `electrician_contact` text NOT NULL,
  `electrician_address` text NOT NULL,
...
--
-- Dumping data for table `electrician_user`
--

INSERT INTO `electrician_user` (`id`, `electricianSer_ID`, `category_id`, `user_ID_no`, `body_no`, `expertise_text`, `electrician_name`, `electrician_contact`, `electrician_address`, `password`, `image_path`, `status`, `delete_flag`, `date_created`, `date_updated`) VALUES
...
--
-- Table structure for table `homeowner_user`
--
...
--
-- Dumping data for table `homeowner_user`
--

INSERT INTO `homeowner_user` (`id`, `firstname`, `middlename`, `lastname`, `gender`, `contact`, `address`, `email`, `password`, `image_path`, `status`, `delete_flag`, `date_created`, `date_added`) VALUES
...
--
-- Indexes for table `electrician_user`
--
ALTER TABLE `electrician_user`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `homeowner_user`
--
ALTER TABLE `homeowner_user`
  ADD PRIMARY KEY (`id`),
...
--
-- AUTO_INCREMENT for table `electrician_user`
--
ALTER TABLE `electrician_user`
...
--
-- AUTO_INCREMENT for table `homeowner_user`
--
ALTER TABLE `homeowner_user`
...
--
ALTER TABLE `booking_list`
  ADD CONSTRAINT `booking_list_ibfk_1` FOREIGN KEY (`cab_id`) REFERENCES `electrician_user` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `booking_list_ibfk_2` FOREIGN KEY (`client_id`) REFERENCES `homeowner_user` (`id`) ON DELETE CASCADE;

--
-- Constraints for table `electrician_user`
--
ALTER TABLE `electrician_user`
  ADD CONSTRAINT `electrician_user_ibfk_1` FOREIGN KEY (`category_id`) REFERENCES `category_list` (`id`) ON DELETE CASCADE;
