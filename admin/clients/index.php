...
<div class="card card-outline card-purple">
	<div class="card-header">
		<h3 class="card-title">List of Household Owners</h3>
	</div>
	<div class="card-body">
        ...
        <div class="container-fluid">
			<table class="table table-bordered table-stripped table-hover">
				...
				<tbody>
					<?php 
					$i = 1;
						$qry = $conn->query("SELECT *,concat(lastname, ', ', firstname,' ',middlename) as fullname from `homeowner_user` where delete_flag= 0 order by concat(lastname, ', ', firstname,' ',middlename) asc ");
