<h1 class=""><i class="fas fa-user"></i> <?php echo $_settings->info('name') ?></h1>
<hr>
<style>
  #cover_img_dash{
    width:100%;
...
<div class="row">
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box">
              ...
              <div class="info-box-content">
                <span class="info-box-text">Available Electricians</span>
                <span class="info-box-number">
                  <?php 
                    $inv = $conn->query("SELECT count(id) as total FROM electrician_user where delete_flag = 0 ")->fetch_assoc()['total'];
                    echo number_format($inv);
                  ?>
                  <?php ?>
                </span>
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="shadow info-box mb-3">
              ...
              <div class="info-box-content">
                <span class="info-box-text">Household Owners</span>
                <span class="info-box-number">
                  <?php 
                    $mechanics = $conn->query("SELECT count(id) as total FROM `homeowner_user` where delete_flag = 0 ")->fetch_assoc()['total'];
