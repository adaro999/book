...
if(isset($_GET['id'])){
$qry = $conn->query("SELECT s.*,cc.category,concat(c.lastname,', ', c.firstname,' ',c.middlename) as fullname,c.email,c.contact, c.address FROM `service_requests` s inner join `categories` cc inner join homeowner_user c on s.client_id = c.id where s.id = '{$_GET['id']}' ");
    ...
    <div class="col-12">
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <div class="form-group">
                    <label for="vehicle_model" class="control-label">Expertise</label>
