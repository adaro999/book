            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    $i = 1;
                        ...
                        $qry = $conn->query("SELECT o.*,CONCAT(c.lastname,', ',c.firstname,' ',c.middlename) as fullname from order_list o inner join homeowner_user c on o.client_id = c.id {$where} order by unix_timestamp(o.date_created) desc");
