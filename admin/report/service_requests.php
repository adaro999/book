            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    $i = 1;
                        ...
                        $qry = $conn->query("SELECT s.*,CONCAT(c.lastname,', ',c.firstname,' ',c.middlename) as fullname from service_requests s inner join homeowner_user c on s.client_id = c.id {$where} order by unix_timestamp(s.date_created) desc");
